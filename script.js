...
function renderRapportPreview(){
  ...
  el.innerHTML = `
    ...
    <div class="card">
      ...
      <div class="detail" style="margin-top:0;"><strong>${plansTermines} / ${THEMATIC_PLANS.length}</strong> plans terminés</div>
      <ul style="padding-left:18px; margin-top:8px;">${plansEntries}</ul>
    </div>
  `;
}
